...
const translations = {
  ...
  hi: {
    ...
    teamVisionIntro: "कौशल महाजन और उदय VVVGFDFGDFGDFGDFFGFGFजाटले, दोनों कंप्यूटर साइंस इंजीनियरिंग के छात्र, इस ऐप को एक साझा दृष्टिकोण के साथ विकसित करने के लिए साझेदारी की है:",
